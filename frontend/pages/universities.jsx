  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Universidades</h1>
          <p className="text-muted-foreground">Gestiona las universidades en el sistema</p>
        </div>
      ...
      <div className="rounded-lg border bg-card shadow">
        <div className="p-4">
          <h3 className="text-lg font-semibold">Lista de Universidades</h3>
        </div>
        <div className="p-4">
