    ...
    {   
        ...
        $resultados = [
            [   
                ...
                'totalCursosConvalidados' => 0,
                'totalCursosRechazados' => 1,
                'totalCreditosEvaluados' => 3,
                'totalCreditosConvalidados' => 0,
                'totalCreditosRechazados' => 3 ,
            ...
            [   
                ...
                'idSolicitud' => 2,
                'totalCursosEvaluados' => 1,
                'totalCursosConvalidados' => 1,
                'totalCursosRechazados' => 0,
                'totalCreditosEvaluados' => 4,
                'totalCreditosConvalidados' => 4,
                'totalCreditosRechazados' => 0,
