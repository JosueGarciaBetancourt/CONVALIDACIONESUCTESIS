...
class CreateSilaboRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'horas_teoria' => 'nullable|integer|min:1',
            'horas_practica' => 'nullable|integer|min:1',
            'horas_teoricoPracticas' => 'nullable|integer|min:1',
            'sumilla' => 'required|string',
            'aprendizaje_general' => 'required|string',
        ];
    }
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            $curso = Curso::find($this->input('idCurso'));
            ...
            // Ninguno de los tres campos ingresados
            if (!$tiene_teoria && !$tiene_practica && !$tiene_teoricoPractica) {
                $validator->errors()->add('horas_teoria', 'Debe ingresar horas teóricas y prácticas, o solo horas teórico-prácticas.');
            }
